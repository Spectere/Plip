...
TEST("RLCA (NC) (initial NC)", "RLCA-NC-InitNC") {  // 0x07
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b01010101);
    LoadData(0x00, 0x07);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b10101010);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
...
TEST("RLCA (C) (initial NC)", "RLCA-NC-InitNC") {  // 0x07
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b10101010);
    LoadData(0x00, 0x07);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b01010101);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLA (NC) (initial C)", "RLA-NC-InitC") {  // 0x17
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b10101011);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLA (C) (initial NC)", "RLA-C-InitNC") {  // 0x17
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b01010100);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RRA (NC) (initial C)", "RRA-NC-InitC") {  // 0x1F
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b11010101);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RRA (C) (initial NC)", "RRA-C-InitNC") {  // 0x1F
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b00101010);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC B (NC, NZ) (initial NC)", "RLC-B-NC,NZ-InitNC") {  // 0xCB, 0x00
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b01010101);
    LoadData(0x00, { 0xCB, 0x00 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b10101010);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC B (C, NZ) (initial NC)", "RLC-B-C,NZ-InitNC") {  // 0xCB, 0x00
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b10101010);
    LoadData(0x00, { 0xCB, 0x00 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b01010101);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC B (NC, Z) (initial NC)", "RLC-B-NC,Z-InitNC") {  // 0xCB, 0x00
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b00000000);
    LoadData(0x00, { 0xCB, 0x00 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_SET;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC C (NC, NZ) (initial NC)", "RLC-C-NC,NZ-InitNC") {  // 0xCB, 0x01
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b01010101);
    LoadData(0x00, { 0xCB, 0x01 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b10101010);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC C (C, NZ) (initial NC)", "RLC-C-C,NZ-InitNC") {  // 0xCB, 0x01
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b10101010);
    LoadData(0x00, { 0xCB, 0x01 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b01010101);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC C (NC, Z) (initial NC)", "RLC-C-NC,Z-InitNC") {  // 0xCB, 0x01
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b00000000);
    LoadData(0x00, { 0xCB, 0x01 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_SET;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC D (NC, NZ) (initial NC)", "RLC-D-NC,NZ-InitNC") {  // 0xCB, 0x02
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b01010101);
    LoadData(0x00, { 0xCB, 0x02 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b10101010);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC D (C, NZ) (initial NC)", "RLC-D-C,NZ-InitNC") {  // 0xCB, 0x02
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b10101010);
    LoadData(0x00, { 0xCB, 0x02 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b01010101);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC D (NC, Z) (initial NC)", "RLC-D-NC,Z-InitNC") {  // 0xCB, 0x02
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b00000000);
    LoadData(0x00, { 0xCB, 0x02 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_SET;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC E (NC, NZ) (initial NC)", "RLC-E-NC,NZ-InitNC") {  // 0xCB, 0x03
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b01010101);
    LoadData(0x00, { 0xCB, 0x03 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b10101010);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC E (C, NZ) (initial NC)", "RLC-E-C,NZ-InitNC") {  // 0xCB, 0x03
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b10101010);
    LoadData(0x00, { 0xCB, 0x03 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b01010101);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC E (NC, Z) (initial NC)", "RLC-E-NC,Z-InitNC") {  // 0xCB, 0x03
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b00000000);
    LoadData(0x00, { 0xCB, 0x03 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_SET;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC H (NC, NZ) (initial NC)", "RLC-H-NC,NZ-InitNC") {  // 0xCB, 0x04
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b01010101);
    LoadData(0x00, { 0xCB, 0x04 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b10101010);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC H (C, NZ) (initial NC)", "RLC-H-C,NZ-InitNC") {  // 0xCB, 0x04
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b10101010);
    LoadData(0x00, { 0xCB, 0x04 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b01010101);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC H (NC, Z) (initial NC)", "RLC-H-NC,Z-InitNC") {  // 0xCB, 0x04
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b00000000);
    LoadData(0x00, { 0xCB, 0x04 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_SET;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC L (NC, NZ) (initial NC)", "RLC-L-NC,NZ-InitNC") {  // 0xCB, 0x05
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b01010101);
    LoadData(0x00, { 0xCB, 0x05 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b10101010);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC L (C, NZ) (initial NC)", "RLC-L-C,NZ-InitNC") {  // 0xCB, 0x05
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b10101010);
    LoadData(0x00, { 0xCB, 0x05 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b01010101);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC L (NC, Z) (initial NC)", "RLC-L-NC,Z-InitNC") {  // 0xCB, 0x05
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b00000000);
    LoadData(0x00, { 0xCB, 0x05 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_SET;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RLC A (NC, Z) (initial NC)", "RLC-A-NC,Z-InitNC") {  // 0xCB, 0x07
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b00000000);
    LoadData(0x00, { 0xCB, 0x07 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_SET;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL B (NC, NZ) (initial C)", "RL-B-NC,NZ-InitC") {  // 0xCB, 0x10
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b10101011);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL B (C, NZ) (initial NC)", "RL-B-NC,NZ-InitNC") {  // 0xCB, 0x10
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b01010100);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL B (NC, Z) (initial NC)", "RL-B-NC,Z-InitNC") {  // 0xCB, 0x10
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b00000000);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_SET;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL B (C, Z) (initial NC)", "RL-B-NC,Z-InitNC") {  // 0xCB, 0x10
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b10000000);
    LoadData(0x00, { 0xCB, 0x10 });
...
TEST("RL C (NC, NZ) (initial C)", "RL-C-NC,NZ-InitC") {  // 0xCB, 0x11
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b10101011);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL C (C, NZ) (initial NC)", "RL-C-NC,NZ-InitNC") {  // 0xCB, 0x11
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b01010100);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL C (NC, Z) (initial NC)", "RL-C-NC,Z-InitNC") {  // 0xCB, 0x11
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b00000000);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_SET;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL C (C, Z) (initial NC)", "RL-C-NC,Z-InitNC") {  // 0xCB, 0x11
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b10000000);
    LoadData(0x00, { 0xCB, 0x11 });
...
TEST("RL D (NC, NZ) (initial C)", "RL-D-NC,NZ-InitC") {  // 0xCB, 0x12
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b10101011);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL D (C, NZ) (initial NC)", "RL-D-NC,NZ-InitNC") {  // 0xCB, 0x12
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b01010100);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL D (NC, Z) (initial NC)", "RL-D-NC,Z-InitNC") {  // 0xCB, 0x12
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b00000000);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_SET;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL D (C, Z) (initial NC)", "RL-D-NC,Z-InitNC") {  // 0xCB, 0x12
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b10000000);
    LoadData(0x00, { 0xCB, 0x12 });
...
TEST("RL E (NC, NZ) (initial C)", "RL-E-NC,NZ-InitC") {  // 0xCB, 0x13
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b10101011);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL E (C, NZ) (initial NC)", "RL-E-NC,NZ-InitNC") {  // 0xCB, 0x13
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b01010100);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL E (NC, Z) (initial NC)", "RL-E-NC,Z-InitNC") {  // 0xCB, 0x13
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b00000000);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_SET;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL E (C, Z) (initial NC)", "RL-E-NC,Z-InitNC") {  // 0xCB, 0x13
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b10000000);
    LoadData(0x00, { 0xCB, 0x13 });
...
TEST("RL H (NC, NZ) (initial C)", "RL-H-NC,NZ-InitC") {  // 0xCB, 0x14
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b10101011);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL H (C, NZ) (initial NC)", "RL-H-NC,NZ-InitNC") {  // 0xCB, 0x14
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b01010100);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL H (NC, Z) (initial NC)", "RL-H-NC,Z-InitNC") {  // 0xCB, 0x14
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b00000000);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_SET;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL H (C, Z) (initial NC)", "RL-H-NC,Z-InitNC") {  // 0xCB, 0x14
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b10000000);
    LoadData(0x00, { 0xCB, 0x14 });
...
TEST("RL L (NC, NZ) (initial C)", "RL-L-NC,NZ-InitC") {  // 0xCB, 0x15
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b10101011);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL L (C, NZ) (initial NC)", "RL-L-NC,NZ-InitNC") {  // 0xCB, 0x15
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b01010100);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL L (NC, Z) (initial NC)", "RL-L-NC,Z-InitNC") {  // 0xCB, 0x15
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b00000000);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_SET;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL L (C, Z) (initial NC)", "RL-L-NC,Z-InitNC") {  // 0xCB, 0x15
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b10000000);
    LoadData(0x00, { 0xCB, 0x15 });
...
TEST("RL A (NC, Z) (initial NC)", "RL-A-NC,Z-InitNC") {  // 0xCB, 0x17
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b00000000);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_SET;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RL A (C, Z) (initial NC)", "RL-A-NC,Z-InitNC") {  // 0xCB, 0x17
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b10000000);
    LoadData(0x00, { 0xCB, 0x17 });
...
TEST("RR B (NC, NZ) (initial C)", "RR-B-NC,NZ-InitC") {  // 0xCB, 0x18
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b11010101);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RR B (C, NZ) (initial NC)", "RR-B-C,NZ-InitNC") {  // 0xCB, 0x18
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b00101010);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RR B (C, Z) (initial NC)", "RR-B-C,Z-InitNC") {  // 0xCB, 0x18
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b00000001);
    LoadData(0x00, { 0xCB, 0x18 });
...
TEST("RR C (NC, NZ) (initial C)", "RR-C-NC,NZ-InitC") {  // 0xCB, 0x19
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b11010101);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RR C (C, NZ) (initial NC)", "RR-C-C,NZ-InitNC") {  // 0xCB, 0x19
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b00101010);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RR C (C, Z) (initial NC)", "RR-C-C,Z-InitNC") {  // 0xCB, 0x19
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b00000001);
    LoadData(0x00, { 0xCB, 0x19 });
...
TEST("RR D (NC, NZ) (initial C)", "RR-D-NC,NZ-InitC") {  // 0xCB, 0x1A
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b11010101);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RR D (C, NZ) (initial NC)", "RR-D-C,NZ-InitNC") {  // 0xCB, 0x1A
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b00101010);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RR D (C, Z) (initial NC)", "RR-D-C,Z-InitNC") {  // 0xCB, 0x1A
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b00000001);
    LoadData(0x00, { 0xCB, 0x1A });
...
TEST("RR E (NC, NZ) (initial C)", "RR-E-NC,NZ-InitC") {  // 0xCB, 0x1B
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b11010101);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RR E (C, NZ) (initial NC)", "RR-E-C,NZ-InitNC") {  // 0xCB, 0x1B
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b00101010);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RR E (C, Z) (initial NC)", "RR-E-C,Z-InitNC") {  // 0xCB, 0x1B
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b00000001);
    LoadData(0x00, { 0xCB, 0x1B });
...
TEST("RR H (NC, NZ) (initial C)", "RR-H-NC,NZ-InitC") {  // 0xCB, 0x1C
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b11010101);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RR H (C, NZ) (initial NC)", "RR-H-C,NZ-InitNC") {  // 0xCB, 0x1C
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b00101010);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RR H (C, Z) (initial NC)", "RR-H-C,Z-InitNC") {  // 0xCB, 0x1C
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b00000001);
    LoadData(0x00, { 0xCB, 0x1C });
...
TEST("RR L (NC, NZ) (initial C)", "RR-L-NC,NZ-InitC") {  // 0xCB, 0x1D
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b11010101);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RR L (C, NZ) (initial NC)", "RR-L-C,NZ-InitNC") {  // 0xCB, 0x1D
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b00101010);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
...
TEST("RR L (C, Z) (initial NC)", "RR-L-C,Z-InitNC") {  // 0xCB, 0x1D
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b00000001);
    LoadData(0x00, { 0xCB, 0x1D });
...
TEST("RR A (C, Z) (initial NC)", "RR-A-C,Z-InitNC") {  // 0xCB, 0x1F
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b00000001);
    LoadData(0x00, { 0xCB, 0x1F });
...
TEST("SWAP B (NZ)", "SWAP-B-NZ") {  // 0xCB, 0x30
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b10101111);
    LoadData(0x00, { 0xCB, 0x30 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b11111010);
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_CARRY_CLEAR;
...
TEST("SWAP C (NZ)", "SWAP-C-NZ") {  // 0xCB, 0x31
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b10101111);
    LoadData(0x00, { 0xCB, 0x31 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b11111010);
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_CARRY_CLEAR;
...
TEST("SWAP D (NZ)", "SWAP-D-NZ") {  // 0xCB, 0x32
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b10101111);
    LoadData(0x00, { 0xCB, 0x32 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b11111010);
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_CARRY_CLEAR;
...
TEST("SWAP E (NZ)", "SWAP-E-NZ") {  // 0xCB, 0x33
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b10101111);
    LoadData(0x00, { 0xCB, 0x33 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b11111010);
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_CARRY_CLEAR;
...
TEST("SWAP H (NZ)", "SWAP-H-NZ") {  // 0xCB, 0x34
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b10101111);
    LoadData(0x00, { 0xCB, 0x34 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b11111010);
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_CARRY_CLEAR;
...
TEST("SWAP L (NZ)", "SWAP-L-NZ") {  // 0xCB, 0x35
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b10101111);
    LoadData(0x00, { 0xCB, 0x35 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b11111010);
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_CARRY_CLEAR;
...
TEST("SWAP A (NZ)", "SWAP-A-NZ") {  // 0xCB, 0x37
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b10101111);
    LoadData(0x00, { 0xCB, 0x37 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b11111010);
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_CARRY_CLEAR;
...
TEST("BIT 0, B (Z)", "BIT-0,B-Z") {  // 0xCB, 0x40
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b11111110);
    LoadData(0x00, { 0xCB, 0x40 });
...
TEST("BIT 1, B (NZ)", "BIT-1,B-NZ") {  // 0xCB, 0x48
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b00000010);
...
TEST("BIT 1, B (Z)", "BIT-1,B-Z") {  // 0xCB, 0x48
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b11111101);
    LoadData(0x00, { 0xCB, 0x48 });
...
TEST("BIT 2, B (NZ)", "BIT-2,B-NZ") {  // 0xCB, 0x50
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b00000100);
...
TEST("BIT 2, B (Z)", "BIT-2,B-Z") {  // 0xCB, 0x50
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b11111011);
    LoadData(0x00, { 0xCB, 0x50 });
...
TEST("BIT 3, B (NZ)", "BIT-3,B-NZ") {  // 0xCB, 0x58
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b00001000);
...
TEST("BIT 3, B (Z)", "BIT-3,B-Z") {  // 0xCB, 0x58
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b11110111);
    LoadData(0x00, { 0xCB, 0x58 });
...
TEST("BIT 4, B (NZ)", "BIT-4,B-NZ") {  // 0xCB, 0x60
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b00010000);
...
TEST("BIT 4, B (Z)", "BIT-4,B-Z") {  // 0xCB, 0x60
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b11101111);
    LoadData(0x00, { 0xCB, 0x60 });
...
TEST("BIT 5, B (NZ)", "BIT-5,B-NZ") {  // 0xCB, 0x68
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b00100000);
...
TEST("BIT 5, B (Z)", "BIT-5,B-Z") {  // 0xCB, 0x68
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b11011111);
    LoadData(0x00, { 0xCB, 0x68 });
...
TEST("BIT 6, B (NZ)", "BIT-6,B-NZ") {  // 0xCB, 0x70
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b01000000);
...
TEST("BIT 6, B (Z)", "BIT-6,B-Z") {  // 0xCB, 0x70
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b10111111);
    LoadData(0x00, { 0xCB, 0x70 });
...
TEST("BIT 7, B (Z)", "BIT-7,B-Z") {  // 0xCB, 0x78
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b01111111);
    LoadData(0x00, { 0xCB, 0x78 });
...
TEST("BIT 0, C (Z)", "BIT-0,C-Z") {  // 0xCB, 0x41
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b11111110);
    LoadData(0x00, { 0xCB, 0x41 });
...
TEST("BIT 1, C (NZ)", "BIT-1,C-NZ") {  // 0xCB, 0x49
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b00000010);
...
TEST("BIT 1, C (Z)", "BIT-1,C-Z") {  // 0xCB, 0x49
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b11111101);
    LoadData(0x00, { 0xCB, 0x49 });
...
TEST("BIT 2, C (NZ)", "BIT-2,C-NZ") {  // 0xCB, 0x51
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b00000100);
...
TEST("BIT 2, C (Z)", "BIT-2,C-Z") {  // 0xCB, 0x51
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b11111011);
    LoadData(0x00, { 0xCB, 0x51 });
...
TEST("BIT 3, C (NZ)", "BIT-3,C-NZ") {  // 0xCB, 0x59
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b00001000);
...
TEST("BIT 3, C (Z)", "BIT-3,C-Z") {  // 0xCB, 0x59
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b11110111);
    LoadData(0x00, { 0xCB, 0x59 });
...
TEST("BIT 4, C (NZ)", "BIT-4,C-NZ") {  // 0xCB, 0x61
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b00010000);
...
TEST("BIT 4, C (Z)", "BIT-4,C-Z") {  // 0xCB, 0x61
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b11101111);
    LoadData(0x00, { 0xCB, 0x61 });
...
TEST("BIT 5, C (NZ)", "BIT-5,C-NZ") {  // 0xCB, 0x69
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b00100000);
...
TEST("BIT 5, C (Z)", "BIT-5,C-Z") {  // 0xCB, 0x69
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b11011111);
    LoadData(0x00, { 0xCB, 0x69 });
...
TEST("BIT 6, C (NZ)", "BIT-6,C-NZ") {  // 0xCB, 0x71
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b01000000);
...
TEST("BIT 6, C (Z)", "BIT-6,C-Z") {  // 0xCB, 0x71
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b10111111);
    LoadData(0x00, { 0xCB, 0x71 });
...
TEST("BIT 7, C (Z)", "BIT-7,C-Z") {  // 0xCB, 0x79
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b01111111);
    LoadData(0x00, { 0xCB, 0x79 });
...
TEST("BIT 0, D (Z)", "BIT-0,D-Z") {  // 0xCB, 0x42
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b11111110);
    LoadData(0x00, { 0xCB, 0x42 });
...
TEST("BIT 1, D (NZ)", "BIT-1,D-NZ") {  // 0xCB, 0x4A
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b00000010);
...
TEST("BIT 1, D (Z)", "BIT-1,D-Z") {  // 0xCB, 0x4A
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b11111101);
    LoadData(0x00, { 0xCB, 0x4A });
...
TEST("BIT 2, D (NZ)", "BIT-2,D-NZ") {  // 0xCB, 0x52
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b00000100);
...
TEST("BIT 2, D (Z)", "BIT-2,D-Z") {  // 0xCB, 0x52
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b11111011);
    LoadData(0x00, { 0xCB, 0x52 });
...
TEST("BIT 3, D (NZ)", "BIT-3,D-NZ") {  // 0xCB, 0x5A
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b00001000);
...
TEST("BIT 3, D (Z)", "BIT-3,D-Z") {  // 0xCB, 0x5A
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b11110111);
    LoadData(0x00, { 0xCB, 0x5A });
...
TEST("BIT 4, D (NZ)", "BIT-4,D-NZ") {  // 0xCB, 0x62
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b00010000);
...
TEST("BIT 4, D (Z)", "BIT-4,D-Z") {  // 0xCB, 0x62
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b11101111);
    LoadData(0x00, { 0xCB, 0x62 });
...
TEST("BIT 5, D (NZ)", "BIT-5,D-NZ") {  // 0xCB, 0x6A
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b00100000);
...
TEST("BIT 5, D (Z)", "BIT-5,D-Z") {  // 0xCB, 0x6A
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b11011111);
    LoadData(0x00, { 0xCB, 0x6A });
...
TEST("BIT 6, D (NZ)", "BIT-6,D-NZ") {  // 0xCB, 0x72
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b01000000);
...
TEST("BIT 6, D (Z)", "BIT-6,D-Z") {  // 0xCB, 0x72
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b10111111);
    LoadData(0x00, { 0xCB, 0x72 });
...
TEST("BIT 7, D (Z)", "BIT-7,D-Z") {  // 0xCB, 0x7A
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b01111111);
    LoadData(0x00, { 0xCB, 0x7A });
...
TEST("BIT 0, E (Z)", "BIT-0,E-Z") {  // 0xCB, 0x43
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b11111110);
    LoadData(0x00, { 0xCB, 0x43 });
...
TEST("BIT 1, E (NZ)", "BIT-1,E-NZ") {  // 0xCB, 0x4B
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b00000010);
...
TEST("BIT 1, E (Z)", "BIT-1,E-Z") {  // 0xCB, 0x4B
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b11111101);
    LoadData(0x00, { 0xCB, 0x4B });
...
TEST("BIT 2, E (NZ)", "BIT-2,E-NZ") {  // 0xCB, 0x53
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b00000100);
...
TEST("BIT 2, E (Z)", "BIT-2,E-Z") {  // 0xCB, 0x53
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b11111011);
    LoadData(0x00, { 0xCB, 0x53 });
...
TEST("BIT 3, E (NZ)", "BIT-3,E-NZ") {  // 0xCB, 0x5B
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b00001000);
...
TEST("BIT 3, E (Z)", "BIT-3,E-Z") {  // 0xCB, 0x5B
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b11110111);
    LoadData(0x00, { 0xCB, 0x5B });
...
TEST("BIT 4, E (NZ)", "BIT-4,E-NZ") {  // 0xCB, 0x63
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b00010000);
...
TEST("BIT 4, E (Z)", "BIT-4,E-Z") {  // 0xCB, 0x63
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b11101111);
    LoadData(0x00, { 0xCB, 0x63 });
...
TEST("BIT 5, E (NZ)", "BIT-5,E-NZ") {  // 0xCB, 0x6B
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b00100000);
...
TEST("BIT 5, E (Z)", "BIT-5,E-Z") {  // 0xCB, 0x6B
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b11011111);
    LoadData(0x00, { 0xCB, 0x6B });
...
TEST("BIT 6, E (NZ)", "BIT-6,E-NZ") {  // 0xCB, 0x73
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b01000000);
...
TEST("BIT 6, E (Z)", "BIT-6,E-Z") {  // 0xCB, 0x73
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b10111111);
    LoadData(0x00, { 0xCB, 0x73 });
...
TEST("BIT 7, E (Z)", "BIT-7,E-Z") {  // 0xCB, 0x7B
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b01111111);
    LoadData(0x00, { 0xCB, 0x7B });
...
TEST("BIT 0, H (Z)", "BIT-0,H-Z") {  // 0xCB, 0x44
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b11111110);
    LoadData(0x00, { 0xCB, 0x44 });
...
TEST("BIT 1, H (NZ)", "BIT-1,H-NZ") {  // 0xCB, 0x4C
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b00000010);
...
TEST("BIT 1, H (Z)", "BIT-1,H-Z") {  // 0xCB, 0x4C
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b11111101);
    LoadData(0x00, { 0xCB, 0x4C });
...
TEST("BIT 2, H (NZ)", "BIT-2,H-NZ") {  // 0xCB, 0x54
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b00000100);
...
TEST("BIT 2, H (Z)", "BIT-2,H-Z") {  // 0xCB, 0x54
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b11111011);
    LoadData(0x00, { 0xCB, 0x54 });
...
TEST("BIT 3, H (NZ)", "BIT-3,H-NZ") {  // 0xCB, 0x5C
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b00001000);
...
TEST("BIT 3, H (Z)", "BIT-3,H-Z") {  // 0xCB, 0x5C
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b11110111);
    LoadData(0x00, { 0xCB, 0x5C });
...
TEST("BIT 4, H (NZ)", "BIT-4,H-NZ") {  // 0xCB, 0x64
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b00010000);
...
TEST("BIT 4, H (Z)", "BIT-4,H-Z") {  // 0xCB, 0x64
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b11101111);
    LoadData(0x00, { 0xCB, 0x64 });
...
TEST("BIT 5, H (NZ)", "BIT-5,H-NZ") {  // 0xCB, 0x6C
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b00100000);
...
TEST("BIT 5, H (Z)", "BIT-5,H-Z") {  // 0xCB, 0x6C
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b11011111);
    LoadData(0x00, { 0xCB, 0x6C });
...
TEST("BIT 6, H (NZ)", "BIT-6,H-NZ") {  // 0xCB, 0x74
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b01000000);
...
TEST("BIT 6, H (Z)", "BIT-6,H-Z") {  // 0xCB, 0x74
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b10111111);
    LoadData(0x00, { 0xCB, 0x74 });
...
TEST("BIT 7, H (Z)", "BIT-7,H-Z") {  // 0xCB, 0x7C
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b01111111);
    LoadData(0x00, { 0xCB, 0x7C });
...
TEST("BIT 0, L (Z)", "BIT-0,L-Z") {  // 0xCB, 0x45
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b11111110);
    LoadData(0x00, { 0xCB, 0x45 });
...
TEST("BIT 1, L (NZ)", "BIT-1,L-NZ") {  // 0xCB, 0x4D
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b00000010);
...
TEST("BIT 1, L (Z)", "BIT-1,L-Z") {  // 0xCB, 0x4D
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b11111101);
    LoadData(0x00, { 0xCB, 0x4D });
...
TEST("BIT 2, L (NZ)", "BIT-2,L-NZ") {  // 0xCB, 0x55
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b00000100);
...
TEST("BIT 2, L (Z)", "BIT-2,L-Z") {  // 0xCB, 0x55
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b11111011);
    LoadData(0x00, { 0xCB, 0x55 });
...
TEST("BIT 3, L (NZ)", "BIT-3,L-NZ") {  // 0xCB, 0x5D
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b00001000);
...
TEST("BIT 3, L (Z)", "BIT-3,L-Z") {  // 0xCB, 0x5D
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b11110111);
    LoadData(0x00, { 0xCB, 0x5D });
...
TEST("BIT 4, L (NZ)", "BIT-4,L-NZ") {  // 0xCB, 0x65
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b00010000);
...
TEST("BIT 4, L (Z)", "BIT-4,L-Z") {  // 0xCB, 0x65
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b11101111);
    LoadData(0x00, { 0xCB, 0x65 });
...
TEST("BIT 5, L (NZ)", "BIT-5,L-NZ") {  // 0xCB, 0x6D
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b00100000);
...
TEST("BIT 5, L (Z)", "BIT-5,L-Z") {  // 0xCB, 0x6D
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b11011111);
    LoadData(0x00, { 0xCB, 0x6D });
...
TEST("BIT 6, L (NZ)", "BIT-6,L-NZ") {  // 0xCB, 0x75
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b01000000);
...
TEST("BIT 6, L (Z)", "BIT-6,L-Z") {  // 0xCB, 0x75
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b10111111);
    LoadData(0x00, { 0xCB, 0x75 });
...
TEST("BIT 7, L (Z)", "BIT-7,L-Z") {  // 0xCB, 0x7D
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b01111111);
    LoadData(0x00, { 0xCB, 0x7D });
...
TEST("BIT 0, A (Z)", "BIT-0,A-Z") {  // 0xCB, 0x47
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b11111110);
    LoadData(0x00, { 0xCB, 0x47 });
...
TEST("BIT 1, A (NZ)", "BIT-1,A-NZ") {  // 0xCB, 0x4F
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b00000010);
...
TEST("BIT 1, A (Z)", "BIT-1,A-Z") {  // 0xCB, 0x4F
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b11111101);
    LoadData(0x00, { 0xCB, 0x4F });
...
TEST("BIT 2, A (NZ)", "BIT-2,A-NZ") {  // 0xCB, 0x57
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b00000100);
...
TEST("BIT 2, A (Z)", "BIT-2,A-Z") {  // 0xCB, 0x57
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b11111011);
    LoadData(0x00, { 0xCB, 0x57 });
...
TEST("BIT 3, A (NZ)", "BIT-3,A-NZ") {  // 0xCB, 0x5F
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b00001000);
...
TEST("BIT 3, A (Z)", "BIT-3,A-Z") {  // 0xCB, 0x5F
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b11110111);
    LoadData(0x00, { 0xCB, 0x5F });
...
TEST("BIT 4, A (NZ)", "BIT-4,A-NZ") {  // 0xCB, 0x67
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b00010000);
...
TEST("BIT 4, A (Z)", "BIT-4,A-Z") {  // 0xCB, 0x67
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b11101111);
    LoadData(0x00, { 0xCB, 0x67 });
...
TEST("BIT 5, A (NZ)", "BIT-5,A-NZ") {  // 0xCB, 0x6F
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b00100000);
...
TEST("BIT 5, A (Z)", "BIT-5,A-Z") {  // 0xCB, 0x6F
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b11011111);
    LoadData(0x00, { 0xCB, 0x6F });
...
TEST("BIT 6, A (NZ)", "BIT-6,A-NZ") {  // 0xCB, 0x77
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b01000000);
...
TEST("BIT 6, A (Z)", "BIT-6,A-Z") {  // 0xCB, 0x77
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b10111111);
    LoadData(0x00, { 0xCB, 0x77 });
...
TEST("BIT 7, A (Z)", "BIT-7,A-Z") {  // 0xCB, 0x7F
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b01111111);
    LoadData(0x00, { 0xCB, 0x7F });
...
TEST("RES 0, B", "RES-0,B") {  // 0xCB, 0x80
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexB, 0b11111111);
    LoadData(0x00, { 0xCB, 0x80 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b11111110);
}
...
TEST("RES 1, B", "RES-1,B") {  // 0xCB, 0x88
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b11111101);
}
...
TEST("RES 2, B", "RES-2,B") {  // 0xCB, 0x90
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b11111011);
}
...
TEST("RES 3, B", "RES-3,B") {  // 0xCB, 0x98
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b11110111);
}
...
TEST("RES 4, B", "RES-4,B") {  // 0xCB, 0xA0
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b11101111);
}
...
TEST("RES 5, B", "RES-5,B") {  // 0xCB, 0xA8
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b11011111);
}
...
TEST("RES 6, B", "RES-6,B") {  // 0xCB, 0xB0
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b10111111);
}
...
TEST("RES 7, B", "RES-7,B") {  // 0xCB, 0xB8
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b01111111);
}

TEST("RES 0, C", "RES-0,C") {  // 0xCB, 0x81
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexC, 0b11111111);
    LoadData(0x00, { 0xCB, 0x81 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b11111110);
}
...
TEST("RES 1, C", "RES-1,C") {  // 0xCB, 0x89
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b11111101);
}
...
TEST("RES 2, C", "RES-2,C") {  // 0xCB, 0x91
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b11111011);
}
...
TEST("RES 3, C", "RES-3,C") {  // 0xCB, 0x99
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b11110111);
}
...
TEST("RES 4, C", "RES-4,C") {  // 0xCB, 0xA1
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b11101111);
}
...
TEST("RES 5, C", "RES-5,C") {  // 0xCB, 0xA9
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b11011111);
}
...
TEST("RES 6, C", "RES-6,C") {  // 0xCB, 0xB1
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b10111111);
}
...
TEST("RES 7, C", "RES-7,C") {  // 0xCB, 0xB9
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b01111111);
}

TEST("RES 0, D", "RES-0,D") {  // 0xCB, 0x82
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexD, 0b11111111);
    LoadData(0x00, { 0xCB, 0x82 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b11111110);
}
...
TEST("RES 1, D", "RES-1,D") {  // 0xCB, 0x8A
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b11111101);
}
...
TEST("RES 2, D", "RES-2,D") {  // 0xCB, 0x92
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b11111011);
}
...
TEST("RES 3, D", "RES-3,D") {  // 0xCB, 0x9A
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b11110111);
}
...
TEST("RES 4, D", "RES-4,D") {  // 0xCB, 0xA2
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b11101111);
}
...
TEST("RES 5, D", "RES-5,D") {  // 0xCB, 0xAA
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b11011111);
}
...
TEST("RES 6, D", "RES-6,D") {  // 0xCB, 0xB2
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b10111111);
}
...
TEST("RES 7, D", "RES-7,D") {  // 0xCB, 0xBA
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b01111111);
}

TEST("RES 0, E", "RES-0,E") {  // 0xCB, 0x83
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexE, 0b11111111);
    LoadData(0x00, { 0xCB, 0x83 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b11111110);
}
...
TEST("RES 1, E", "RES-1,E") {  // 0xCB, 0x8B
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b11111101);
}
...
TEST("RES 2, E", "RES-2,E") {  // 0xCB, 0x93
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b11111011);
}
...
TEST("RES 3, E", "RES-3,E") {  // 0xCB, 0x9B
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b11110111);
}
...
TEST("RES 4, E", "RES-4,E") {  // 0xCB, 0xA3
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b11101111);
}
...
TEST("RES 5, E", "RES-5,E") {  // 0xCB, 0xAB
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b11011111);
}
...
TEST("RES 6, E", "RES-6,E") {  // 0xCB, 0xB3
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b10111111);
}
...
TEST("RES 7, E", "RES-7,E") {  // 0xCB, 0xBB
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b01111111);
}

TEST("RES 0, H", "RES-0,H") {  // 0xCB, 0x84
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexH, 0b11111111);
    LoadData(0x00, { 0xCB, 0x84 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b11111110);
}
...
TEST("RES 1, H", "RES-1,H") {  // 0xCB, 0x8C
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b11111101);
}
...
TEST("RES 2, H", "RES-2,H") {  // 0xCB, 0x94
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b11111011);
}
...
TEST("RES 3, H", "RES-3,H") {  // 0xCB, 0x9C
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b11110111);
}
...
TEST("RES 4, H", "RES-4,H") {  // 0xCB, 0xA4
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b11101111);
}
...
TEST("RES 5, H", "RES-5,H") {  // 0xCB, 0xAC
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b11011111);
}
...
TEST("RES 6, H", "RES-6,H") {  // 0xCB, 0xB4
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b10111111);
}
...
TEST("RES 7, H", "RES-7,H") {  // 0xCB, 0xBC
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b01111111);
}

TEST("RES 0, L", "RES-0,L") {  // 0xCB, 0x85
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexL, 0b11111111);
    LoadData(0x00, { 0xCB, 0x85 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b11111110);
}
...
TEST("RES 1, L", "RES-1,L") {  // 0xCB, 0x8D
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b11111101);
}
...
TEST("RES 2, L", "RES-2,L") {  // 0xCB, 0x95
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b11111011);
}
...
TEST("RES 3, L", "RES-3,L") {  // 0xCB, 0x9D
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b11110111);
}
...
TEST("RES 4, L", "RES-4,L") {  // 0xCB, 0xA5
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b11101111);
}
...
TEST("RES 5, L", "RES-5,L") {  // 0xCB, 0xAD
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b11011111);
}
...
TEST("RES 6, L", "RES-6,L") {  // 0xCB, 0xB5
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b10111111);
}
...
TEST("RES 7, L", "RES-7,L") {  // 0xCB, 0xBD
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b01111111);
}
...
TEST("RES 0, A", "RES-0,A") {  // 0xCB, 0x87
    cpu->SetRegister8ByIndex(MockSharpSm83::RegIndexA, 0b11111111);
    LoadData(0x00, { 0xCB, 0x87 });

    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b11111110);
}
...
TEST("RES 1, A", "RES-1,A") {  // 0xCB, 0x8F
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b11111101);
}
...
TEST("RES 2, A", "RES-2,A") {  // 0xCB, 0x97
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b11111011);
}
...
TEST("RES 3, A", "RES-3,A") {  // 0xCB, 0x9F
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b11110111);
}
...
TEST("RES 4, A", "RES-4,A") {  // 0xCB, 0xA7
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b11101111);
}
...
TEST("RES 5, A", "RES-5,A") {  // 0xCB, 0xAF
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b11011111);
}
...
TEST("RES 6, A", "RES-6,A") {  // 0xCB, 0xB7
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b10111111);
}
...
TEST("RES 7, A", "RES-7,A") {  // 0xCB, 0xBF
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b01111111);
}
...
TEST("SET 0, B", "SET-0,B") {  // 0xCB, 0xC0
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b00000001);
}
...
TEST("SET 1, B", "SET-1,B") {  // 0xCB, 0xC8
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b00000010);
}
...
TEST("SET 2, B", "SET-2,B") {  // 0xCB, 0xD0
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b00000100);
}
...
TEST("SET 3, B", "SET-3,B") {  // 0xCB, 0xD8
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b00001000);
}
...
TEST("SET 4, B", "SET-4,B") {  // 0xCB, 0xE0
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b00010000);
}
...
TEST("SET 5, B", "SET-5,B") {  // 0xCB, 0xE8
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b00100000);
}
...
TEST("SET 6, B", "SET-6,B") {  // 0xCB, 0xF0
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b01000000);
}
...
TEST("SET 7, B", "SET-7,B") {  // 0xCB, 0xF8
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexB) == 0b10000000);
}
...
TEST("SET 0, C", "SET-0,C") {  // 0xCB, 0xC1
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b00000001);
}
...
TEST("SET 1, C", "SET-1,C") {  // 0xCB, 0xC9
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b00000010);
}
...
TEST("SET 2, C", "SET-2,C") {  // 0xCB, 0xD1
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b00000100);
}
...
TEST("SET 3, C", "SET-3,C") {  // 0xCB, 0xD9
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b00001000);
}
...
TEST("SET 4, C", "SET-4,C") {  // 0xCB, 0xE1
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b00010000);
}
...
TEST("SET 5, C", "SET-5,C") {  // 0xCB, 0xE9
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b00100000);
}
...
TEST("SET 6, C", "SET-6,C") {  // 0xCB, 0xF1
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b01000000);
}
...
TEST("SET 7, C", "SET-7,C") {  // 0xCB, 0xF9
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexC) == 0b10000000);
}
...
TEST("SET 0, D", "SET-0,D") {  // 0xCB, 0xC2
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b00000001);
}
...
TEST("SET 1, D", "SET-1,D") {  // 0xCB, 0xCA
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b00000010);
}
...
TEST("SET 2, D", "SET-2,D") {  // 0xCB, 0xD2
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b00000100);
}
...
TEST("SET 3, D", "SET-3,D") {  // 0xCB, 0xDA
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b00001000);
}
...
TEST("SET 4, D", "SET-4,D") {  // 0xCB, 0xE2
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b00010000);
}
...
TEST("SET 5, D", "SET-5,D") {  // 0xCB, 0xEA
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b00100000);
}
...
TEST("SET 6, D", "SET-6,D") {  // 0xCB, 0xF2
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b01000000);
}
...
TEST("SET 7, D", "SET-7,D") {  // 0xCB, 0xFA
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexD) == 0b10000000);
}
...
TEST("SET 0, E", "SET-0,E") {  // 0xCB, 0xC3
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b00000001);
}
...
TEST("SET 1, E", "SET-1,E") {  // 0xCB, 0xCB
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b00000010);
}
...
TEST("SET 2, E", "SET-2,E") {  // 0xCB, 0xD3
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b00000100);
}
...
TEST("SET 3, E", "SET-3,E") {  // 0xCB, 0xDB
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b00001000);
}
...
TEST("SET 4, E", "SET-4,E") {  // 0xCB, 0xE3
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b00010000);
}
...
TEST("SET 5, E", "SET-5,E") {  // 0xCB, 0xEB
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b00100000);
}
...
TEST("SET 6, E", "SET-6,E") {  // 0xCB, 0xF3
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b01000000);
}
...
TEST("SET 7, E", "SET-7,E") {  // 0xCB, 0xFB
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexE) == 0b10000000);
}
...
TEST("SET 0, H", "SET-0,H") {  // 0xCB, 0xC4
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b00000001);
}
...
TEST("SET 1, H", "SET-1,H") {  // 0xCB, 0xCC
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b00000010);
}
...
TEST("SET 2, H", "SET-2,H") {  // 0xCB, 0xD4
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b00000100);
}
...
TEST("SET 3, H", "SET-3,H") {  // 0xCB, 0xDC
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b00001000);
}
...
TEST("SET 4, H", "SET-4,H") {  // 0xCB, 0xE4
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b00010000);
}
...
TEST("SET 5, H", "SET-5,H") {  // 0xCB, 0xEC
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b00100000);
}
...
TEST("SET 6, H", "SET-6,H") {  // 0xCB, 0xF4
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b01000000);
}
...
TEST("SET 7, H", "SET-7,H") {  // 0xCB, 0xFC
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexH) == 0b10000000);
}
...
TEST("SET 0, L", "SET-0,L") {  // 0xCB, 0xC5
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b00000001);
}
...
TEST("SET 1, L", "SET-1,L") {  // 0xCB, 0xCD
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b00000010);
}
...
TEST("SET 2, L", "SET-2,L") {  // 0xCB, 0xD5
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b00000100);
}
...
TEST("SET 3, L", "SET-3,L") {  // 0xCB, 0xDD
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b00001000);
}
...
TEST("SET 4, L", "SET-4,L") {  // 0xCB, 0xE5
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b00010000);
}
...
TEST("SET 5, L", "SET-5,L") {  // 0xCB, 0xED
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b00100000);
}
...
TEST("SET 6, L", "SET-6,L") {  // 0xCB, 0xF5
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b01000000);
}
...
TEST("SET 7, L", "SET-7,L") {  // 0xCB, 0xFD
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexL) == 0b10000000);
}
...
TEST("SET 0, A", "SET-0,A") {  // 0xCB, 0xC7
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b00000001);
}
...
TEST("SET 1, A", "SET-1,A") {  // 0xCB, 0xCF
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b00000010);
}
...
TEST("SET 2, A", "SET-2,A") {  // 0xCB, 0xD7
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b00000100);
}
...
TEST("SET 3, A", "SET-3,A") {  // 0xCB, 0xDF
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b00001000);
}
...
TEST("SET 4, A", "SET-4,A") {  // 0xCB, 0xE7
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b00010000);
}
...
TEST("SET 5, A", "SET-5,A") {  // 0xCB, 0xEF
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b00100000);
}
...
TEST("SET 6, A", "SET-6,A") {  // 0xCB, 0xF7
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b01000000);
}
...
TEST("SET 7, A", "SET-7,A") {  // 0xCB, 0xFF
    ...
    EXECUTE(2);
    CHECK(cpu->GetRegister8ByIndex(MockSharpSm83::RegIndexA) == 0b10000000);
}
