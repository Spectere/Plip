...
TEST("INC B (NH, NZ)", "INC-B-NH-NZ") {  // 0x04
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexB) == 0x01);
    CHECK_HALF_CLEAR;
...
TEST("INC B (H, NZ)", "INC-B-H-NZ") {  // 0x04
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0x0F);
    LoadData(0x00, 0x04);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexB) == 0x10);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC B (H, Z)", "INC-B-H-Z") {  // 0x04
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0xFF);
    LoadData(0x00, 0x04);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexB) == 0x00);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_SET;
}
...
TEST("DEC B (NH, NZ)", "DEC-B-NH-NZ") {  // 0x05
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0x02);
    LoadData(0x00, 0x05);
...
TEST("DEC B (NH, Z)", "DEC-B-NH-Z") {  // 0x05
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0x01);
    LoadData(0x00, 0x05);
...
TEST("DEC B (H, NZ)", "DEC-B-H-NZ") {  // 0x05
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexB) == 0xFF);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_SET;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC C (NH, NZ)", "INC-C-NH-NZ") {  // 0x0C
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexC) == 0x01);
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC C (H, NZ)", "INC-C-H-NZ") {  // 0x0C
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexC, 0x0F);
    LoadData(0x00, 0x0C);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexC) == 0x10);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC C (H, Z)", "INC-C-H-Z") {  // 0x0C
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexC, 0xFF);
    LoadData(0x00, 0x0C);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexC) == 0x00);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_SET;
}
...
TEST("DEC C (NH, NZ)", "DEC-C-NH-NZ") {  // 0x0D
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexC, 0x02);
    LoadData(0x00, 0x0D);
...
TEST("DEC C (NH, Z)", "DEC-C-NH-Z") {  // 0x0D
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexC, 0x01);
    LoadData(0x00, 0x0D);
...
TEST("DEC C (H, NZ)", "DEC-C-H-NZ") {  // 0x0D
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexC) == 0xFF);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_SET;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC D (NH, NZ)", "INC-D-NH-NZ") {  // 0x14
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexD) == 0x01);
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC D (H, NZ)", "INC-D-H-NZ") {  // 0x14
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexD, 0x0F);
    LoadData(0x00, 0x14);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexD) == 0x10);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC D (H, Z)", "INC-D-H-Z") {  // 0x14
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexD, 0xFF);
    LoadData(0x00, 0x14);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexD) == 0x00);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_SET;
}
...
TEST("DEC D (NH, NZ)", "DEC-D-NH-NZ") {  // 0x15
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexD, 0x02);
    LoadData(0x00, 0x15);
...
TEST("DEC D (NH, Z)", "DEC-D-NH-Z") {  // 0x15
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexD, 0x01);
    LoadData(0x00, 0x15);
...
TEST("DEC D (H, NZ)", "DEC-D-H-NZ") {  // 0x15
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexD) == 0xFF);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_SET;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC E (NH, NZ)", "INC-E-NH-NZ") {  // 0x1C
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexE) == 0x01);
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC E (H, NZ)", "INC-E-H-NZ") {  // 0x1C
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexE, 0x0F);
    LoadData(0x00, 0x1C);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexE) == 0x10);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC E (H, Z)", "INC-E-H-Z") {  // 0x1C
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexE, 0xFF);
    LoadData(0x00, 0x1C);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexE) == 0x00);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_SET;
}
...
TEST("DEC E (NH, NZ)", "DEC-E-NH-NZ") {  // 0x1D
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexE, 0x02);
    LoadData(0x00, 0x1D);
...
TEST("DEC E (NH, Z)", "DEC-E-NH-Z") {  // 0x1D
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexE, 0x01);
    LoadData(0x00, 0x1D);
...
TEST("DEC E (H, NZ)", "DEC-E-H-NZ") {  // 0x1D
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexE) == 0xFF);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_SET;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC H (NH, NZ)", "INC-H-NH-NZ") {  // 0x24
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexH) == 0x01);
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC H (H, NZ)", "INC-H-H-NZ") {  // 0x24
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexH, 0x0F);
    LoadData(0x00, 0x24);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexH) == 0x10);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC H (H, Z)", "INC-H-H-Z") {  // 0x24
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexH, 0xFF);
    LoadData(0x00, 0x24);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexH) == 0x00);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_SET;
}
...
TEST("DEC H (NH, NZ)", "DEC-H-NH-NZ") {  // 0x25
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexH, 0x02);
    LoadData(0x00, 0x25);
...
TEST("DEC H (NH, Z)", "DEC-H-NH-Z") {  // 0x25
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexH, 0x01);
    LoadData(0x00, 0x25);
...
TEST("DEC H (H, NZ)", "DEC-H-H-NZ") {  // 0x25
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexH) == 0xFF);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_SET;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC L (NH, NZ)", "INC-L-NH-NZ") {  // 0x2C
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexL) == 0x01);
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC L (H, NZ)", "INC-L-H-NZ") {  // 0x2C
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexL, 0x0F);
    LoadData(0x00, 0x2C);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexL) == 0x10);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC L (H, Z)", "INC-L-H-Z") {  // 0x2C
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexL, 0xFF);
    LoadData(0x00, 0x2C);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexL) == 0x00);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_SET;
}
...
TEST("DEC L (NH, NZ)", "DEC-L-NH-NZ") {  // 0x2D
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexL, 0x02);
    LoadData(0x00, 0x2D);
...
TEST("DEC L (NH, Z)", "DEC-L-NH-Z") {  // 0x2D
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexL, 0x01);
    LoadData(0x00, 0x2D);
...
TEST("DEC L (H, NZ)", "DEC-L-H-NZ") {  // 0x2D
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexL) == 0xFF);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_SET;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC A (NH, NZ)", "INC-A-NH-NZ") {  // 0x3C
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x01);
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC A (H, NZ)", "INC-A-H-NZ") {  // 0x3C
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x0F);
    LoadData(0x00, 0x3C);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x10);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
}
...
TEST("INC A (H, Z)", "INC-A-H-Z") {  // 0x3C
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xFF);
    LoadData(0x00, 0x3C);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x00);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_SET;
}
...
TEST("DEC A (NH, NZ)", "DEC-A-NH-NZ") {  // 0x3D
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x02);
    LoadData(0x00, 0x3D);
...
TEST("DEC A (NH, Z)", "DEC-A-NH-Z") {  // 0x3D
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x01);
    LoadData(0x00, 0x3D);
...
TEST("DEC A (H, NZ)", "DEC-A-H-NZ") {  // 0x3D
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0xFF);
    CHECK_HALF_SET;
    CHECK_SUBTRACT_SET;
    CHECK_ZERO_CLEAR;
}
...
TEST("DAA (NS, H, NC) (NZ, NC)", "DAA-NS,NH,NC-NZ,NC") {  // 0x27
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x07);
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_CARRY_CLEAR;
...
TEST("DAA (NS, IH, NC) (NZ, NC)", "DAA-NS,IH,NC-NZ,NC") {  // 0x27
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x0A);
    LoadData(0x00, 0x27);
...
TEST("DAA (NS, NH, C) (NZ, C)", "DAA-NS,NH,C-NZ,C") {  // 0x27
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x00);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x27);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x60);
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_CARRY_SET;
...
TEST("DAA (NS, NH, IC) (NZ, C)", "DAA-NS,NH,IC-NZ,C") {  // 0x27
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xA1);
    LoadData(0x00, 0x27);
...
TEST("DAA (NS, H, C) (NZ, C)", "DAA-NS,H,C-NZ,C") {  // 0x27
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x66);
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_CARRY_SET;
...
TEST("DAA (NS, IH, C) (NZ, C)", "DAA-NS,IH,C-NZ,C") {  // 0x27
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x70);
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_CARRY_SET;
...
TEST("DAA (NS, H, IC) (NZ, C)", "DAA-NS,H,IC-NZ,C") {  // 0x27
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xA0);
    cpu->SetHalfCarryFlag();
    cpu->SetCarryFlag();
    LoadData(0x00, 0x27);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x06);
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_CARRY_SET;
...
TEST("DAA (NS, IH, IC) (NZ, C)", "DAA-NS,IH,IC-NZ,C") {  // 0x27
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xAA);
    LoadData(0x00, 0x27);
...
TEST("DAA (S, H, NC) (NZ, NC)", "DAA-S-H,NC-NZ,NC") {  // 0x27
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x07);
    cpu->SetSubtractFlag();
    cpu->SetHalfCarryFlag();
    LoadData(0x00, 0x27);
...
TEST("DAA (S, H, NC) (Z, NC)", "DAA-S-H,NC-Z,NC") {  // 0x27
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x06);
    cpu->SetSubtractFlag();
    cpu->SetHalfCarryFlag();
    LoadData(0x00, 0x27);
...
TEST("DAA (S, NH, C) (NZ, NC)", "DAA-S-NH,C-NZ,NC") {  // 0x27
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x70);
    cpu->SetSubtractFlag();
    cpu->SetCarryFlag();
    LoadData(0x00, 0x27);
...
TEST("DAA (S, NH, C) (Z, NC)", "DAA-S-NH,C-Z,NC") {  // 0x27
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x60);
    cpu->SetSubtractFlag();
    cpu->SetCarryFlag();
    LoadData(0x00, 0x27);
...
TEST("DAA (S, H, C) (NZ, NC)", "DAA-S-H,C-NZ,NC") {  // 0x27
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x77);
    cpu->SetSubtractFlag();
    cpu->SetHalfCarryFlag();
    cpu->SetCarryFlag();
    LoadData(0x00, 0x27);
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x11);
    CHECK_ZERO_CLEAR;
    CHECK_SUBTRACT_SET;
    CHECK_HALF_CLEAR;
    CHECK_CARRY_SET;
...
TEST("DAA (S, H, C) (Z, NC)", "DAA-S-H,C-Z,NC") {  // 0x27
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x66);
    cpu->SetSubtractFlag();
    cpu->SetHalfCarryFlag();
    cpu->SetCarryFlag();
    LoadData(0x00, 0x27);
...
TEST("ADD A, B (NC, NH, NZ)", "ADD-A,B-NC-NH-NZ") {  // 0x80
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x01);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0x0E);
    LoadData(0x00, 0x80);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x0F);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
...
TEST("ADD A, B (C, NH, NZ)", "ADD-A,B-C-NH-NZ") {  // 0x80
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xF0);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0x20);
    LoadData(0x00, 0x80);
...
TEST("ADD A, C (NC, NH, NZ)", "ADD-A,C-NC-NH-NZ") {  // 0x81
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x01);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexC, 0x0E);
    LoadData(0x00, 0x81);
...
TEST("ADD A, C (C, NH, NZ)", "ADD-A,C-C-NH-NZ") {  // 0x81
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xF0);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexC, 0x20);
    LoadData(0x00, 0x81);
...
TEST("ADD A, D (NC, NH, NZ)", "ADD-A,D-NC-NH-NZ") {  // 0x82
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x01);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexD, 0x0E);
    LoadData(0x00, 0x82);
...
TEST("ADD A, D (C, NH, NZ)", "ADD-A,D-C-NH-NZ") {  // 0x82
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xF0);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexD, 0x20);
    LoadData(0x00, 0x82);
...
TEST("ADD A, E (NC, NH, NZ)", "ADD-A,E-NC-NH-NZ") {  // 0x83
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x01);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexE, 0x0E);
    LoadData(0x00, 0x83);
...
TEST("ADD A, E (C, NH, NZ)", "ADD-A,E-C-NH-NZ") {  // 0x83
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xF0);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexE, 0x20);
    LoadData(0x00, 0x83);
...
TEST("ADD A, H (NC, NH, NZ)", "ADD-A,H-NC-NH-NZ") {  // 0x84
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x01);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexH, 0x0E);
    LoadData(0x00, 0x84);
...
TEST("ADD A, H (C, NH, NZ)", "ADD-A,H-C-NH-NZ") {  // 0x84
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xF0);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexH, 0x20);
    LoadData(0x00, 0x84);
...
TEST("ADD A, L (NC, NH, NZ)", "ADD-A,L-NC-NH-NZ") {  // 0x85
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x01);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexL, 0x0E);
    LoadData(0x00, 0x85);
...
TEST("ADD A, L (C, NH, NZ)", "ADD-A,L-C-NH-NZ") {  // 0x85
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xF0);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexL, 0x20);
    LoadData(0x00, 0x85);
...
TEST("ADD A, A (NC, NH, NZ)", "ADD-A,A-NC-NH-NZ") {  // 0x87
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x04);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
...
TEST("ADD A, A (C, NH, NZ)", "ADD-A,A-C-NH-NZ") {  // 0x87
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x90);
    LoadData(0x00, 0x87);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x20);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
...
TEST("ADD A, A (NC, H, NZ)", "ADD-A,A-NC-H-NZ") {  // 0x87
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x08);
    LoadData(0x00, 0x87);
...
TEST("ADD A, A (C, H, NZ)", "ADD-A,A-C-H-NZ") {  // 0x87
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x99);
    LoadData(0x00, 0x87);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x32);
    CHECK_CARRY_SET;
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
...
TEST("ADD A, A (C, NH, Z)", "ADD-A,A-C-NH-Z") {  // 0x87
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x80);
    LoadData(0x00, 0x87);
...
TEST("ADC A, B (C) (NC, NH, NZ)", "ADC-A,B-C-NC-NH-NZ") {  // 0x88
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x01);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0x0D);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x88);
...
TEST("ADC A, B (C) (C, NH, Z)", "ADC-A,B-C-C-NH-Z") {  // 0x88
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xFF);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0x00);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x88);
...
TEST("ADC A, C (C) (NC, NH, NZ)", "ADC-A,C-C-NC-NH-NZ") {  // 0x89
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x01);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexC, 0x0D);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x89);
...
TEST("ADC A, C (C) (C, H, Z)", "ADC-A,C-C-C-H-Z") {  // 0x89
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xFF);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexC, 0x00);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x89);
...
TEST("ADC A, D (C) (NC, NH, NZ)", "ADC-A,D-C-NC-NH-NZ") {  // 0x8A
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x01);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexD, 0x0D);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x8A);
...
TEST("ADC A, D (C) (C, H, Z)", "ADC-A,D-C-C-H-Z") {  // 0x8A
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xFF);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexD, 0x00);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x8A);
...
TEST("ADC A, E (C) (NC, NH, NZ)", "ADC-A,E-C-NC-NH-NZ") {  // 0x8B
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x01);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexE, 0x0D);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x8B);
...
TEST("ADC A, E (C) (C, H, Z)", "ADC-A,E-C-C-H-Z") {  // 0x8B
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xFF);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexE, 0x00);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x8B);
...
TEST("ADC A, H (C) (NC, NH, NZ)", "ADC-A,H-C-NC-NH-NZ") {  // 0x8C
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x01);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexH, 0x0D);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x8C);
...
TEST("ADC A, H (C) (C, H, Z)", "ADC-A,H-C-C-H-Z") {  // 0x8C
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xFF);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexH, 0x00);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x8C);
...
TEST("ADC A, L (C) (NC, NH, NZ)", "ADC-A,L-C-NC-NH-NZ") {  // 0x8D
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x01);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexL, 0x0D);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x8D);
...
TEST("ADC A, L (C) (C, H, Z)", "ADC-A,L-C-C-H-Z") {  // 0x8D
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xFF);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexL, 0x00);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x8D);
...
TEST("ADC A, A (C) (NC, NH, NZ)", "ADC-A,A-C-NC-NH-NZ") {  // 0x8F
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x05);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
...
TEST("ADC A, A (C) (NC, H, NZ)", "ADC-A,A-C-NC-H-NZ") {  // 0x8F
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xE);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x8F);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x1D);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
...
TEST("ADC A, A (C) (C, NH, NZ)", "ADC-A,A-C-C-NH-NZ") {  // 0x8F
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x81);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x8F);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x03);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
...
TEST("ADC A, A (C) (C, H, NZ)", "ADC-A,A-C-C-H-NZ") {  // 0x8F
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x88);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x8F);
...
TEST("SUB A, B (NC, NH, NZ)", "SUB-A,B-NC-NH-NZ") {  // 0x90
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x04);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0x03);
    LoadData(0x00, 0x90);
...
TEST("SUB A, B (NC, H, NZ)", "SUB-A,B-NC-H-NZ") {  // 0x90
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x10);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0x02);
    LoadData(0x00, 0x90);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x0E);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_SET;
    CHECK_SUBTRACT_SET;
    CHECK_ZERO_CLEAR;
...
TEST("SUB A, B (C, NH, NZ)", "SUB-A,B-C-NH-NZ") {  // 0x90
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x08);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0x10);
    LoadData(0x00, 0x90);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0xF8);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_SET;
    CHECK_ZERO_CLEAR;
...
TEST("SUB A, C (NC, NH, NZ)", "SUB-A,C-NC-NH-NZ") {  // 0x91
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x04);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexC, 0x03);
    LoadData(0x00, 0x91);
...
TEST("SUB A, C (C, NH, NZ)", "SUB-A,C-C-NH-NZ") {  // 0x91
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x08);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexC, 0x10);
    LoadData(0x00, 0x91);
...
TEST("SUB A, D (NC, NH, NZ)", "SUB-A,D-NC-NH-NZ") {  // 0x92
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x04);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexD, 0x03);
    LoadData(0x00, 0x92);
...
TEST("SUB A, D (C, NH, NZ)", "SUB-A,D-C-NH-NZ") {  // 0x92
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x08);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexD, 0x10);
    LoadData(0x00, 0x92);
...
TEST("SUB A, E (NC, NH, NZ)", "SUB-A,E-NC-NH-NZ") {  // 0x93
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x04);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexE, 0x03);
    LoadData(0x00, 0x93);
...
TEST("SUB A, E (C, NH, NZ)", "SUB-A,E-C-NH-NZ") {  // 0x93
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x08);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexE, 0x10);
    LoadData(0x00, 0x93);
...
TEST("SUB A, H (NC, NH, NZ)", "SUB-A,H-NC-NH-NZ") {  // 0x94
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x04);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexH, 0x03);
    LoadData(0x00, 0x94);
...
TEST("SUB A, H (C, NH, NZ)", "SUB-A,H-C-NH-NZ") {  // 0x94
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x08);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexH, 0x10);
    LoadData(0x00, 0x94);
...
TEST("SUB A, L (NC, NH, NZ)", "SUB-A,L-NC-NH-NZ") {  // 0x95
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x04);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexL, 0x03);
    LoadData(0x00, 0x95);
...
TEST("SUB A, L (C, NH, NZ)", "SUB-A,L-C-NH-NZ") {  // 0x95
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0x08);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexL, 0x10);
    LoadData(0x00, 0x95);
...
TEST("SBC A, B (C) (C, NH, NZ)", "SBC-A,B-C-C-NH-NZ") {  // 0x98
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0xF7);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_SET;
    CHECK_ZERO_CLEAR;
...
TEST("SBC A, B (C) (NC, NH, Z)", "SBC-A,B-C-NC-NH-Z") {  // 0x98
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xFF);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0xFE);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x98);
...
TEST("SBC A, C (C) (NC, NH, Z)", "SBC-A,C-C-NC-NH-Z") {  // 0x99
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xFF);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexC, 0xFE);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x99);
...
TEST("SBC A, D (C) (NC, NH, Z)", "SBC-A,D-C-NC-NH-Z") {  // 0x9A
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xFF);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexD, 0xFE);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x9A);
...
TEST("SBC A, E (C) (NC, NH, Z)", "SBC-A,E-C-NC-NH-Z") {  // 0x9B
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xFF);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexE, 0xFE);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x9B);
...
TEST("SBC A, H (C) (NC, NH, Z)", "SBC-A,H-C-NC-NH-Z") {  // 0x9C
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xFF);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexH, 0xFE);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x9C);
...
TEST("SBC A, L (C) (NC, NH, Z)", "SBC-A,L-C-NC-NH-Z") {  // 0x9D
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xFF);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexL, 0xFE);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x9D);
...
TEST("SBC A, A (C, H)", "SBC-A,A-C,H") {  // 0x9F
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0xFA);
    cpu->SetCarryFlag();
    LoadData(0x00, 0x9F);
...
TEST("AND A, B (NZ)", "AND-A,B-NZ") {  // 0xA0
    ...
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0b10100011);
    LoadData(0x00, 0xA0);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0b10100011);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
...
TEST("AND A, B (Z)", "AND-A,B-Z") {  // 0xA0
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0b01011100);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0b10100011);
    LoadData(0x00, 0xA0);
...
TEST("AND A, C (NZ)", "AND-A,C-NZ") {  // 0xA1
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0b11111111);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexC, 0b10100011);
    LoadData(0x00, 0xA1);
...
TEST("AND A, D (NZ)", "AND-A,D-NZ") {  // 0xA2
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0b11111111);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexD, 0b10100011);
    LoadData(0x00, 0xA2);
...
TEST("AND A, E (NZ)", "AND-A,E-NZ") {  // 0xA3
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0b11111111);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexE, 0b10100011);
    LoadData(0x00, 0xA3);
...
TEST("AND A, H (NZ)", "AND-A,H-NZ") {  // 0xA4
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0b11111111);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexH, 0b10100011);
    LoadData(0x00, 0xA4);
...
TEST("AND A, L (NZ)", "AND-A,L-NZ") {  // 0xA5
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0b11111111);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexL, 0b10100011);
    LoadData(0x00, 0xA5);
...
TEST("AND A, A (NZ)", "AND-A,A-NZ") {  // 0xA7
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0b01011100);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_SET;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
...
TEST("AND A, A (Z)", "AND-A,A-Z") {  // 0xA7
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0);
    LoadData(0x00, 0xA7);
...
TEST("XOR A, B (NZ)", "XOR-A,B-NZ") {  // 0xA8
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0b11110000);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0b10100011);
    LoadData(0x00, 0xA8);

    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0b01010011);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
...
TEST("XOR A, B (Z)", "XOR-A,B-Z") {  // 0xA8
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0b11110000);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0b11110000);
    LoadData(0x00, 0xA8);
...
TEST("XOR A, C (Z)", "XOR-A,C-Z") {  // 0xA9
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0b11110000);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexC, 0b11110000);
    LoadData(0x00, 0xA9);
...
TEST("XOR A, D (Z)", "XOR-A,D-Z") {  // 0xAA
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0b11110000);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexD, 0b11110000);
    LoadData(0x00, 0xAA);
...
TEST("XOR A, E (Z)", "XOR-A,E-Z") {  // 0xAB
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0b11110000);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexE, 0b11110000);
    LoadData(0x00, 0xAB);
...
TEST("XOR A, H (Z)", "XOR-A,H-Z") {  // 0xAC
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0b11110000);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexH, 0b11110000);
    LoadData(0x00, 0xAC);
...
TEST("XOR A, L (Z)", "XOR-A,L-Z") {  // 0xAD
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0b11110000);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexL, 0b11110000);
    LoadData(0x00, 0xAD);
...
TEST("OR A, B (NZ)", "OR-A,B-NZ") {  // 0xB0
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0b11110011);
    CHECK_CARRY_CLEAR;
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_CLEAR;
    CHECK_ZERO_CLEAR;
...
TEST("OR A, B (Z)", "OR-A,B-Z") {  // 0xB0
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexB, 0);
    LoadData(0x00, 0xB0);
...
TEST("OR A, C (Z)", "OR-A,C-Z") {  // 0xB1
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexC, 0);
    LoadData(0x00, 0xB1);
...
TEST("OR A, D (Z)", "OR-A,D-Z") {  // 0xB2
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexD, 0);
    LoadData(0x00, 0xB2);
...
TEST("OR A, E (Z)", "OR-A,E-Z") {  // 0xB3
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexE, 0);
    LoadData(0x00, 0xB3);
...
TEST("OR A, H (Z)", "OR-A,H-Z") {  // 0xB4
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexH, 0);
    LoadData(0x00, 0xB4);
...
TEST("OR A, L (Z)", "OR-A,L-Z") {  // 0xB5
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexA, 0);
    cpu->SetRegister8ByIndex(MockSharpLr35902::RegIndexL, 0);
    LoadData(0x00, 0xB5);
...
TEST("CP A, B (C, NH, NZ)", "CP-A,B-C-NH-NZ") {  // 0xB8
    ...
    EXECUTE(1);
    CHECK(cpu->GetRegister8ByIndex(MockSharpLr35902::RegIndexA) == 0x08);
    CHECK_CARRY_SET;
    CHECK_HALF_CLEAR;
    CHECK_SUBTRACT_SET;
    CHECK_ZERO_CLEAR;
